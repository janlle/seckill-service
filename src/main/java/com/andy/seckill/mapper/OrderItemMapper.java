...
public interface OrderItemMapper {
    ...
    @Insert("insert into t_order_item(goods_id, order_id, picture, price, count, total, create_time) values(orderDetail.goodsId, orderDetail.orderId, orderDetail.picture, orderDetail.price, orderDetail.count, orderDetail.total, orderDetail.createTime)")
